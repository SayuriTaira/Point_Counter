...
const playerFour = {
    count: document.querySelector('.container4 .count'),
    buttons: document.querySelectorAll('.container4 .button'),
    counter: 0
}
...
playerFour.buttons.forEach((btn) => {
    btn.addEventListener('click', (e) => {
        const btnClass = e.currentTarget.classList
        updateCounter(playerFour, btnClass)
    })
});